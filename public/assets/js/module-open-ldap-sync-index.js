 ...
 */
var ModuleOpenLdapSyncIndex = {
  $autoSyncStatuses: $('.checkbox.server-sync-status'),
  initialize: function initialize() {
    // Enable/disable server checkbox handlers
    ModuleOpenLdapSyncIndex.$autoSyncStatuses.checkbox({
      onChecked: function onChecked() {
        var id = $(this).closest('tr').attr('id');
        $.api({
          url: "".concat(globalRootUrl, "module-open-ldap-sync/module-open-ldap-sync/enable/{id}"),
          on: 'now',
          urlData: {
            id: id
          }
      ...
      onUnchecked: function onUnchecked() {
        var id = $(this).closest('tr').attr('id');
        $.api({
          url: "".concat(globalRootUrl, "module-open-ldap-sync/module-open-ldap-sync/disable/{id}"),
          on: 'now',
          urlData: {
            id: id
          }
